...
const Profile = () => {
  ...
  const [data, setData] = useState<UserInfo | any>(
  ...
  const updateAvater = (uri: string | Blob) => {
    ...
    axios
      ...
      .then((res) => {
        if (res.status === 200) {
          axios
            .patch(`${apiurl}/patient/update/avater/${data.id}`, {
          ...
          <View style={styles.detailsCard}>
            <View style={styles.editContainer}>
              {data && (
                <TouchableOpacity
                  activeOpacity={0.8}
                  onPress={() => router.push("/editpatientinfo")}
                >
        ...
        <View style={styles.personalInfoContainer}>
          ...
          {!showDetails ? (
            <View style={styles.noinfo}>
              ...
              <TouchableOpacity
                activeOpacity={0.8}
                onPress={() => router.push("/addpatientinfo")}
              >
            ...
            <View style={styles.info}>
              <View style={styles.personalInfoTxtContianer}>
                <Text style={styles.personalInfoTxt}>Student ID:</Text>
                <Text style={styles.detailTxt}>
                  {data ? data.studentid : "Not set"}
                </Text>
              </View>
              <View style={styles.personalInfoTxtContianer}>
              ...
              {/* <View style={styles.personalInfoTxtContianer}>
                <Text style={styles.personalInfoTxt}>Age:</Text>
                <Text style={styles.detailTxt}>
                  {data.studentid}
                </Text>
              </View> */}
